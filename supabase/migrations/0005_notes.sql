...
create index notes_recent_idx on public.notes (user_id, updated_at desc);
...
create index metric_logs_key_idx on public.metric_logs (user_id, metric_key, recorded_at desc);
